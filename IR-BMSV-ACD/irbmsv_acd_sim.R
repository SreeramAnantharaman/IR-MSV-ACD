...
filenamet<-sprintf("bmsv_g2_time.rds")
filename0 <-sprintf("bmsv_g2_lpd.rds")
filename <-sprintf("bmsv_g2_summ.rds")
filename1 <-sprintf("bmsv_g2_full.rds")
filename2 <- sprintf("bmsv_g2_waic.rds")
...
filename3_1 <- sprintf("bmsv_g2_maetrain1.rds")
...
filename5_1 <- sprintf("bmsv_g2_maetest1.rds")
