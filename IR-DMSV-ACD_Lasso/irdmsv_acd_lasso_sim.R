...
filenamet<-sprintf("dmsv_g2lasso_time_%s.rds",z)
filename0 <-sprintf("dmsv_g2lasso_lpd_%s.rds",z)
filename <-sprintf("dmsv_g2lasso_summ_%s.rds",z)
filename1 <-sprintf("dmsv_g2lasso_full_%s.rds",z)
